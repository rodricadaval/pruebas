...
else
{
    ...
    case 'agregar_toner':
        $select_areas = Areas::dameSelect('', '');
        $select_impresoras = Impresoras::dameSelect();
        $url   = array("vista/toner/view_agregar_toner.php");        
        $parametros = array("select_areas" => $select_areas,"select_impresoras" => $select_impresoras);
        echo Disenio::HTML($url, $parametros);
        break;
        
    case 'agregar_tablet':
        $select_marcas = Tablets::dameSelectMarcas();
        $select_modelos = Tablets::dameSelectModelos();;
        $url   = array("vista/tablet/view_agregar_tablet.php");        
        $parametros = array("select_marcas" => $select_marcas,"select_modelos" => $select_modelos);
        echo Disenio::HTML($url, $parametros);
        break;

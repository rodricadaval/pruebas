...
<form id="form_asignar_monitor_a_compu" autocomplete="off">
...
<script type="text/javascript">
    ...
    $("#form_asignar_monitor_a_compu").validate({
        onfocusout: false,
        onkeyup: false,
        onclick: false,
        onsubmit: true,
        ...
        submitHandler : function (form) {
            ...
            console.log($("#form_asignar_monitor_a_compu").serialize());
            var dataUrl = $("#form_asignar_monitor_a_compu").serialize() + "&tipo=Monitor&id_cpu="+$("#tab_memorias_y_discos").attr("id_cpu");
            ...
            $.ajax({
                            ...
                            success: function(response){
                                ...
                                $("#tabs3").empty();
                                $( "#agregar_monitor_computadora" ).trigger( "click" );
